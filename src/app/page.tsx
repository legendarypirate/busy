            ...
            <div className="col-lg-6 mt-5 mt-lg-0">
              ...
              <div className="dashboard-mockup">
                <div className="mockup-sidebar d-none d-md-flex">
                  ...
                  <div className="sidebar-nav-item active"><i className="fa-solid fa-house"></i> Нүүр</div>
                  <div className="sidebar-nav-item"><i className="fa-solid fa-paper-plane"></i> Аялалууд</div>
                  <div className="sidebar-nav-item"><i className="fa-solid fa-calendar-days"></i> Хурал, эвентүүд</div>
                  <div className="sidebar-nav-item"><i className="fa-solid fa-user-check"></i> Бүртгэлүүд</div>
                  <div className="sidebar-nav-item"><i className="fa-solid fa-credit-card"></i> Төлбөрүүд</div>
                  <div className="sidebar-nav-item"><i className="fa-solid fa-clock"></i> Хуваарь</div>
                  <div className="sidebar-nav-item"><i className="fa-solid fa-chart-pie"></i> Тайлан, үр дүн</div>
                </div>
                <div className="mockup-main">
                  ...
                  <div className="mockup-activity-section">
                    <div className="activity-card">
                      ...
                      <div className="mt-3">
                        <div className="d-flex justify-content-between small mb-1">
                          ...
                          <span className="text-muted">{tripTotal > 0 ? Math.round((tripActive / tripTotal) * 100) : 0}%</span>
                        </div>
                        <div className="progress" style={{ height: 4 }}>
                          <div className="progress-bar bg-primary" style={{ width: `${tripTotal > 0 ? Math.round((tripActive / tripTotal) * 100) : 0}%` }}></div>
                        </div>
                      </div>
                    </div>
                    <div className="registrations-card">
                      ...
                      <Link href="/dashboard" className="d-block text-center small text-primary mt-2">Бүгдийг харах</Link>
                    </div>
                  </div>
                </div>
              </div>
