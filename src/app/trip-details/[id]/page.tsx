        ...
        <div className="row g-4 g-lg-5 align-items-lg-start">
          ...
          <div className="col-lg-8 order-2 order-lg-1">
            ...
            {paymentSteps.length > 0 ? (
              <div id="trd-section-payment-steps" className="mb-5 trd-scroll-anchor trd-payment-steps-box">
                <div className="d-flex align-items-center justify-content-between gap-3 flex-wrap mb-3">
                  <h2 className="fw-bold mb-0">Төлбөрийн үе шат</h2>
                </div>
                <div className="trd-payment-step-track" aria-hidden="true" />
                <div className="trd-payment-step-grid">
                  {paymentSteps.map((step, idx) => (
                    <div key={`pay-step-${idx}-${step.title}`} className="trd-payment-step-item">
                      <div className="trd-payment-step-num">{idx + 1}</div>
                      <div className="trd-payment-step-icon">
                        <i className="fa-solid fa-money-check-dollar" />
                      </div>
                      <div className="trd-payment-step-title">{step.title}</div>
                      <div className="trd-payment-step-note">{step.note || "—"}</div>
                    </div>
                  ))}
                </div>
              </div>
